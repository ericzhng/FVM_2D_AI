...
def create_and_mesh_rectangle(
    ...
    through the middle, and then meshes it with either a structured grid of
    quadrilateral elements or an unstructured grid of triangular elements.
    ...
    if mesh_type == "structured" and (nx % 2 != 0 or ny % 2 != 0):
        print(
            "Warning: For a structured mesh, it is recommended that nx and ny be even numbers."
        )
